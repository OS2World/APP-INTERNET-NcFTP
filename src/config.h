...
#define gethost_addrptr_t struct in_addr *
...
#define PREFIX_BINDIR "/progetti/ncftp-3.2.5/os2/bin"
...
#define read_size_t int

#define recv_return_t int

#define recv_size_t int
...
/* Result of "uname -a" */
#define UNAME "OS/2 NEOIII 1 2.45 i386 i386 AuthenticAMD OS/2"
